...
| Project | Summary |
| --- | --- |
| [object_detection_robot](https://github.com/lee-seong-wook/object_detection_robot) | Robotic arm pipeline for detection, data collection, augmentation, and motion control, implemented with Python, OpenCV, YOLO, and Raspberry Pi. |
