...
- **Current focus:** Lightweight medical image segmentation, robust preprocessing in difficult conditions, and deployable vision pipelines.
- **Research interests:** Medical AI, computer vision, object detection, and edge / on-device systems.
- **Technical stack:** Python, PyTorch, OpenCV, Linux, and Raspberry Pi / embedded prototyping.

## Ongoing Research Engagements

- **NRF / Hallym University Future Medical Research Center (2026)**<br/>미래의료연구센터 육성사업 - 뇌신경계 임상현장 난제 해결을 위한 융합형 의사과학자 육성 및 현장맞춤형 미래의료선도기술 실용화 사업
- **KOCCA (2025)** — On-Device AI 모델 저작권 보호 및 관리를 위한 글로벌 인재양성
- **Hallym University collaboration (2025)** — 의료 데이터를 활용한 연합학습 기반 뇌졸중 예후 예측 모델 개발 연구

## Selected Research Publications

- **[Lightweight SwiM-UNet with multi-dimensional adaptor for efficient on-device medical image segmentation](https://scholar.google.com/citations?view_op=view_citation&hl=ko&user=nsm4HuYAAAAJ&citation_for_view=nsm4HuYAAAAJ:qjMakFHDy7sC)** — Scientific Reports, 2026. Lightweight segmentation for on-device deployment.
- **[Lightweight Dual-Backbone Framework for Tea Leaf Disease Detection](https://scholar.google.com/citations?view_op=view_citation&hl=ko&user=nsm4HuYAAAAJ&citation_for_view=nsm4HuYAAAAJ:Y0pCki6q_DkC)** — IEEE ISCT, 2025. Resource-aware tea leaf disease detection.
- **[YOLOv10 기반 저조도 환경에서 객체 인식 성능 향상을 위한 이미지 전처리 기법 비교](https://scholar.google.com/citations?view_op=view_citation&hl=ko&user=nsm4HuYAAAAJ&citation_for_view=nsm4HuYAAAAJ:d1gkVwhDpl0C)** — KIIT Conference, 2024. Low-light preprocessing for stronger object detection.
